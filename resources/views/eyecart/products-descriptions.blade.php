									...
									<div class="grid images_3_of_2">
										<div class="flexslider1">
											...
											<ul class="slides">
												...
												<li data-thumb="{{ asset('assets/eye/customer/images/d1.jpg')}}">
													<div class="thumb-image"> <img src="{{ asset('assets/eye/customer/images/d1.jpg')}}" data-imagezoom="true" class="img-fluid" alt=" "> </div>
												</li>
												<li data-thumb="{{ asset('assets/eye/customer/images/d3.jpg')}}">
													<div class="thumb-image"> <img src="{{ asset('assets/eye/customer/images/d3.jpg')}}" data-imagezoom="true" class="img-fluid" alt=" "> </div>
												</li>
											</ul>
													...
													<div class="bootstrap-tab-text-grids">
														<div class="bootstrap-tab-text-grid">
															<div class="bootstrap-tab-text-grid-left">
																<img src="{{ asset('assets/eye/customer/images/team1.jpg')}}" alt=" " class="img-fluid">
															</div>
